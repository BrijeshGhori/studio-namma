...
// let page = document.querySelector(".part1AT");
// let page2 = document.querySelectorAll(".part1A-text > span");


// let observer = new IntersectionObserver((entries)=>{
//   entries.forEach((entry)=>{
//     if(entry.isIntersecting){
//       entry.target.classList.add("textRise");
//     }
//     else{
//       entry.target.classList.remove("textRise");
//     }
...
const part1Elements = document.querySelectorAll(
    ".part1AT, .part1A-text span"
);
...
part1Elements.forEach((element) => {
    part1Observer.observe(element);
});
...
const part2Elements = document.querySelectorAll(
    ".part2AT, .part2AR span"
);

const part2Observer = new IntersectionObserver((entries) => {
...
part2Elements.forEach((element) => {
    part2Observer.observe(element);
});
